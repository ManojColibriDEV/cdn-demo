  ...
  return /* @__PURE__ */ w.jsxs("div", { className: `flex! items-center! py-3! px-4! rounded! ${y.bg} ${y.border} ${h}`, children: [
    ...
    /* @__PURE__ */ w.jsxs("div", { className: "ml-3! flex-1! flex! items-center! gap-2!", children: [
      ...
      r && o && /* @__PURE__ */ w.jsx(
        "button",
        {
          type: "button",
          onClick: o,
          className: `text-sm! font-medium! ${y.actionColor} ${y.actionHover} underline! bg-transparent! border-none! cursor-pointer! p-0! whitespace-nowrap!`,
          children: r
        }
      ),
      d
    ...
    s && /* @__PURE__ */ w.jsxs(
      "button",
      {
        type: "button",
        onClick: s,
        className: `ml-2! flex-shrink-0! inline-flex! ${y.iconColor} hover:${y.text} bg-transparent! border-none! cursor-pointer! p-0!`,
        children: [
...
const {
  ...
  getAdapter: wS,
  mergeConfig: zS
} = He, lS = "https://dev-demo-env.colibricore.io", Qi = (u) => {
...
};
{
  class u extends HTMLElement {
    ...
    handleRedirect = (r, o) => {
      console.log("[Widget] handleRedirect called, url:", r);
      ...
      this.dispatchEvent(s), console.log("[Widget] Redirect event dispatched"), r && (console.log("[Widget] Will redirect to:", r, "in 200ms"), setTimeout(() => {
