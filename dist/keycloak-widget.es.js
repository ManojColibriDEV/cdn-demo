    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ W.jsxs("div", { className: "bg-white! rounded-lg! shadow-lg! p-8! w-full! max-w-lg! relative!", children: [
        ...
        /* @__PURE__ */ W.jsxs("div", { className: "mb-6! text-center!", children: [
          ...
          /* @__PURE__ */ W.jsx("p", { className: "text-sm! text-gray-600! mt-2!", children: r })
        ] }),
        /* @__PURE__ */ W.jsxs("form", { onSubmit: vt, className: "space-y-4!", children: [
          ...
          /* @__PURE__ */ W.jsxs("div", { className: "flex! items-center! justify-between! text-sm! mt-2!", children: [
