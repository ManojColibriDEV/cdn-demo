    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ W.jsxs("div", { className: "bg-white! rounded-lg! shadow-lg! p-8! w-full! max-w-lg! relative!", children: [
        ...
        /* @__PURE__ */ W.jsxs("form", { onSubmit: vt, className: "space-y-2!", children: [
          ...
          /* @__PURE__ */ W.jsxs("div", { className: "flex! items-center! justify-between! text-sm! mt-4! ml-0! mb-4! mr-0!", children: [
            /* @__PURE__ */ W.jsxs("label", { className: "flex! items-center!", children: [
              /* @__PURE__ */ W.jsx(
                "input",
                {
                  type: "checkbox",
