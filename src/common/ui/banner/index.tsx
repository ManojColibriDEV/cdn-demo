...
const Banner: FC<BannerProps> = ({
  ...
  const getIcon = () => {
    switch (type) {
      case MessageType.SUCCESS:
        return (
          <svg part="identity-widget-banner-icon-svg" className="identity-widget-banner-icon-svg w-5! h-5!" fill="currentColor" viewBox="0 0 20 20">
            <path
              fillRule="evenodd"
      ...
      case MessageType.INFO:
      default:
        return <img part="identity-widget-banner-icon-image" src={infoWarningCircle} alt="info" className="identity-widget-banner-icon-image w-5! h-5!" />;
    }
  };
  ...
  return (
    ...
    >
      <div part="identity-widget-banner-icon" className={`identity-widget-banner-icon flex-shrink-0! ${styles.iconColor}!`} aria-hidden="true">
        {getIcon()}
      </div>
      <div part="identity-widget-banner-content" className="identity-widget-banner-content ml-3! flex-1! flex! items-center! gap-2! max-[500px]:items-start! max-[500px]:flex-col!">
        <span part="identity-widget-banner-message" className={`identity-widget-banner-message text-sm! font-medium! ${styles.text}`}>{message}</span>
      ...
      {onClose && (
        ...
        >
          <span part="identity-widget-banner-close-text" className="identity-widget-banner-close-text sr-only">Dismiss</span>
          <svg part="identity-widget-banner-close-icon" className="identity-widget-banner-close-icon w-5! h-5!" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
            <path
              fillRule="evenodd"
