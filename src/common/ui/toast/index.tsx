  ...
  return (
    ...
    >
      <div
        ...
        className={`identity-widget-toast-body flex! items-center! p-4! rounded-lg! shadow-lg! ${styles.bg}`}
      >
        <div
          part="identity-widget-toast-icon"
          className={`identity-widget-toast-icon flex-shrink-0! ${styles.icon}`}
          aria-hidden="true"
        >
          {getIcon()}
        </div>
        <div
          ...
          className={`identity-widget-toast-content ml-3! flex-1! ${styles.text}`}
        >
          <p
